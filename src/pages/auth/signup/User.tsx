    ...
    <div className="block md:w-1/2">
      ...
      <form action="" className="p-3"> 
       <div className="block py-2">
        <label htmlFor="text-sm mb-3"><span className="text-red-500">*</span>FirstName</label>
        <input type="text" className="block bg-gray-100 outline-none w-full h-[50px] rounded-lg px-3" placeholder="FirstName" />
       </div>

       <div className="block py-2">
        <label htmlFor="text-sm mb-5"><span className="text-red-500">*</span>SureName</label>
        <input type="text" className="block bg-gray-100 outline-none w-full h-[50px] rounded-lg px-3" placeholder="FirstName" />
       </div>

       <div className="block py-2">
        <label htmlFor="text-sm"><span className="text-red-500"></span>Others</label>
        <input type="text" className="block bg-gray-100 outline-none w-full h-[50px] rounded-lg px-3" placeholder="FirstName" />
       </div>
       ...
       <div className="block py-2">
        <label htmlFor="text-sm"><span className="text-red-500">*</span>Confirm Password</label>
        <input type="password" className="block bg-gray-100 outline-none w-full h-[50px] rounded-lg px-3" placeholder="atlist 6 digit" />
       </div>
